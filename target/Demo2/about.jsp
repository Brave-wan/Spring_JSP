...
<head>
    ...
    <script>
        function loadData() {
            ...
            xmlhttp.open("GET", "http://localhost:8088/about.html", true)
            xmlhttp.send()
        }
    </script>
...
<div class="container">
    <div class="row">
        <button type="button" onclick="loadData()">请求数据</button>
        <p>多次点击按钮，可以看到时间变化。</p>

        <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1" id="myDiv">
